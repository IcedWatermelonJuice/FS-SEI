import torch
from torch.nn import Module,MaxPool1d, Flatten, BatchNorm1d,LazyLinear
import torch.nn.functional as F
from pretext.architectures.complexcnn import ComplexConv

class CVCNNFeature(Module):
    def __init__(self,opt):
        super(CVCNNFeature, self).__init__()
...
def create_model(opt):
    return CVCNNFeature(opt)


if __name__ == "__main__":
    input = torch.randn(128, 2, 4800)
